...
- Οι μαθητές θα πρέπει να έχουν δικό τους laptop με προεγκατεστημένο λογισμικό, 
- Παρακάτω προτείνουμε το λειτουργικό 
- Τις ελάχιστες απιτήσεις σε υλικό
- Τις εφαρμογές που θα εγκαταστήσετε 
- Τέλος στον φάκελο `MATERIAL` θα βρείτε οδηγίες και υλικό που καλείστε να παρακολουθήσετε πριν ξεκινήσουν τα μαθήματα.
